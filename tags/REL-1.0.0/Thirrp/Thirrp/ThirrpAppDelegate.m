...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  {
    UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"Internet Connection Error"
      message:@"Are you connected to the Internet?" delegate:self
...
- (void )application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo
{
  ...
  if ( NULL != [[userInfo objectForKey:@"aps"] objectForKey:@"badge"] )
  {
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Thirrp has come up with the answer to your question!"
      message:nil
      delegate:nil
