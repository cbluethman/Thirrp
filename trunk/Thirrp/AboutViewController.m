...
- (void)viewDidLoad
{
  ...
  [_tvAbout setText: NSLocalizedString( @"I am Thirrp!  I know all, I see all, I am all.  I can answer any question.  Try me!  Touch Ask Question to get started.", @"I am Thirrp!  I know all, I see all, I am all.  I can answer any question.  Try me!  Touch Ask Question to get started." )];
  ...
  if ( YES == _app.firstCoreData )
  {
    dispatch_queue_t queue = dispatch_get_global_queue(
     ...
     dispatch_async(queue, ^{ [self fillCoreData]; });
  }
